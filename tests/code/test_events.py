...
def test_eventTemplate_model():
    ...
    template = EventTemplate(
        name="test", templateJSON='{"first entry":["number one", "number two"]}'
    )
...
def test_preprocessEventData_dates():
    ...
    eventData = {
        "startDate": parser.parse("09/07/21"),
        "endDate": 75,
        "isRecurring": "on",
    }
    newData = preprocessEventData(eventData)
...
def test_correctValidateNewEventData():
    ...
    eventData = {
        ...
        "isTraining": True,
        "isRecurring": False,
        "startDate": parser.parse("1999-12-12"),
        "endDate": parser.parse("2022-06-12"),
        "programId": 1,
        "location": "a big room",
        "timeEnd": "04:00",
        "timeStart": "06:00",
        ...
        "term": 1,
        "contactName": "Kaidou of the Beast",
        "contactEmail": "beastpirates@gmail.com",
    }
...
def test_wrongValidateNewEventData():
    eventData = {
        ...
        "term": 1,
        "contactName": "Big Mom",
        "contactEmail": "weeeDDDINgCAKKe@gmail.com",
    }
    ...
    for boolKey in ["isRsvpRequired", "isTraining", "isService", "isRecurring"]:
        ...
        assert (
            eventErrorMessage
            == "Raw form data passed to validate method. Preprocess first."
        )
...
def test_calculateRecurringEventFrequency():
    ...
    assert returnedEvents[0] == {
        "name": "testEvent Week 1",
        "date": parser.parse("02/22/2023"),
        "week": 1,
    }
    assert returnedEvents[1] == {
        "name": "testEvent Week 2",
        "date": parser.parse("03/01/2023"),
        "week": 2,
    }
    assert returnedEvents[2] == {
        "name": "testEvent Week 3",
        "date": parser.parse("03/08/2023"),
        "week": 3,
    }
...
def test_attemptSaveEvent():
    ...
    eventInfo = {
        ...
        "timeStart": "06:00 PM",
        "description": "Empty Bowls Spring 2021",
        "name": "Attempt Save Test",
        "term": 1,
        "contactName": "Garrett D. Clark",
...
def test_saveEventToDb_create():
    ...
    eventInfo = {
        ...
        "recurringId": None,
        "startDate": parser.parse("2021-12-12"),
        "endDate": parser.parse("2022-06-12"),
        "location": "a big room",
        "timeEnd": "09:00 PM",
        "timeStart": "06:00 PM",
        ...
        "name": "Empty Bowls Spring",
        "term": 1,
        "contactName": "Finn D. Bledsoe",
        "contactEmail": "finnimanBledsoe@pigeoncarrier.com",
    }
    eventInfo["program"] = Program.get_by_id(1)
    ...
    with mainDB.atomic() as transaction:
        with app.app_context():
            eventInfo = {
                ...
                "name": "Empty Bowls Spring",
                "term": 1,
                "contactName": "Brianblius Ramsablius",
...
def test_deleteEvent():
    with mainDB.atomic() as transaction:
        ...
        recurringEventsBefore = list(
            Event.select()
            .where(Event.recurringId == recurringId)
            .order_by(Event.recurringId)
        )
...
def test_upcomingEvents():
    with mainDB.atomic() as transaction:
        ...
        noProgram = Event.create(
            name="Upcoming event with no program",
            term=2,
        ...
        # new program
        newProgramEvent = Event.create(
            name="Upcoming event with  program",
            term=2,
        ...
        newRecurringEvent = Event.create(
        ...
        newRecurringSecond = Event.create(
            name="Recurring second event",
            term=2,
            description="Test upcoming program event.",
            location="The sun",
        ...
        newRecurringDifferentId = Event.create(
            name="Recurring different Id",
            term=2,
            description="Test upcoming program event.",
            location="The sun",
        ...
        programForInterest = Program.create(
            id=13,
            programName="BOO",
            isStudentLed=False,
...
def test_volunteerHistory():
    with mainDB.atomic() as transaction:
        ...
        # participated in
        participatedProgramEvent = Event.create(
            name="Attended program event",
            term=2,
        ...
        # participated in
        participatedEvent = Event.create(
            name="Attended event",
            term=2,
        ...
        participatedProgram = Program.create(
            id=13,
            programName="BOO",
            isStudentLed=False,
            isBonnerScholars=False,
...
def test_getPreviousRecurringEventData():
    with mainDB.atomic() as transaction:
        ...
        testingParticipant1 = EventParticipant.create(
            user=User.get_by_id("neillz"), event=testingEvent2.id, hoursEarned=None
        )
        testingParticipant2 = EventParticipant.create(
            user=User.get_by_id("ramsayb2"), event=testingEvent2.id, hoursEarned=None
        )
        testingParticipant3 = EventParticipant.create(
            user=User.get_by_id("khatts"), event=testingEvent2.id, hoursEarned=None
        )
