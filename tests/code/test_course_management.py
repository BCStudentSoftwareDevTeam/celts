...
def test_course_management():
    with mainDB.atomic() as transaction:
        ...
        incompleteCourse = Course.create(
            courseName="Testing Incomplete",
            term=3,
        ...
        CourseInstructor.create(course=submittedCourse.id, user="ramsayb2")
        CourseInstructor.create(course=submittedCourse.id, user="neillz")
        CourseInstructor.create(course=approvedCourse.id, user="ramsayb2")
        ...
        assert incompleteCourse in unapprovedCourses(
            termId
        ), "unapprovedCourses doesn't include INCOMPLETE proposals"
