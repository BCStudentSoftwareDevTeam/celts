...
class Program(baseModel):
    ...
    def url(self):
        ...
        urls = {
                ...
                4: baseUrl + "volunteer-opportunities/people-who-care-program/",
    ...
    def description(self):
        descriptions = {
                        1: "Each year 200 people stand in line to get into Woods-Penniman for the Annual Empty Bowls Event sponsored by the Berea College ceramics students and CELTS. Students, faculty, staff and community members each pay $10 for a beautiful bowl, soup and the privilege of helping those in need in our community.",
