...
from app.logic.minor import createOtherEngagementRequest, updateOtherEngagementRequest, setCommunityEngagementForUser, getSummerExperience, getEngagementTotal, createSummerExperience, updateSummerExperience, getProgramEngagementHistory, getCourseInformation, getCommunityEngagementByTerm, getMinorSpreadsheet, getCCEMinorProposals
...
def createOtherEngagementRequest(username):
    ...
    if request.method == "POST":
        createdProposal = createOtherEngagementRequest(username, request.form.copy())
