    ...
    if method == "addCeltsAdmin":
        if user.isStudent:
            flash(
                ...
                + " "
                + user.lastName
                + " cannot be added as a Celts admin",
                "danger",
            )
        else:
            if user.isCeltsAdmin:
                flash(
                    user.firstName + " " + user.lastName + " is already a Celts Admin",
                    "danger",
                )
            else:
                addCeltsAdmin(user)
                flash(
                    ...
                    + " "
                    + user.lastName
                    + " has been added as a Celts Admin",
                    "success",
                )
        ...
        if not user.isStudent:
            ...
            if user.isCeltsStudentStaff:
                flash(
                    ...
                    + " "
                    + user.lastName
                    + " is already a Celts Student Staff",
                    "danger",
                )
            else:
                ...
                flash(
                    ...
                    + " "
                    + user.lastName
                    + " has been added as a Celts Student Staff",
                    "success",
                )
    elif method == "removeCeltsAdmin":
        removeCeltsAdmin(user)
        flash(
            user.firstName + " " + user.lastName + " is no longer a Celts Admin ",
            "success",
        )
        ...
        flash(
            ...
            + " "
            + user.lastName
            + " is no longer a Celts Student Staff",
            "success",
        )
    return "success"
