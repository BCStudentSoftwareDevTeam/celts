...
from app.logic.events import deleteEvent, attemptSaveEvent, preprocessEventData, calculateRecurringEventFrequency, deleteEventAndAllFollowing, deleteAllRecurringEvents, getBonnerEvents, getCurrentRsvpAmmount
...
def eventDisplay(eventId):
    ...
    # Event View
        ...
        currentEventRsvpAmmount = getCurrentRsvpAmmount(g.current_term)
